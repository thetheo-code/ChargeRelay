...
GET    /api/reports/{id}/download  PDF charge report for a date range.
"""
import io
...
def download_report_pdf(
    ...
    """Return a PDF file containing all completed sessions for the report's
    ...
    pdf_bytes = _build_report_pdf(report_name, from_date, to_date, rows, lang)
    safe_name = report_name.replace(" ", "_").replace("/", "-")
    filename  = f"{safe_name}_{from_date}_{to_date}.pdf"
